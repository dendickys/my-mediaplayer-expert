...
public class MediaService extends Service implements MediaPlayerCallback {
    ...
    public final static String ACTION_CREATE = "id.dendickys.mymediaplayerexpert.mediaservice.create";
    public final static String ACTION_DESTROY = "id.dendickys.mymediaplayerexpert.mediaservie.destroy";
